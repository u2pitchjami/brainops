...
def process_standard_note(note_id, filepath: str | Path, content: str = None, model_ollama: str = None, prompt_name: str = "import", source: str = "import", write_file=True, resume_if_possible: bool = True) -> str:
    """
    ...
    try:
        ...
        update_bloc_response(note_id, note_path, block_index, response.strip(), source, status="processed")
