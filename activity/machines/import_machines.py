#!/usr/bin/env python3
"""
Import CSV files from Windows activity tracker into MariaDB
using mysql.connector instead of pymysql
"""
...
PROCESS_RECAP = "/home/pipo/dev/brain_ops/activity/machines/process_recap.sql"  # script SQL externe
        ...
        for row_idx, row in enumerate(reader):
            ...
            try:
                cursor.execute(
                    ...
                    (machine_id, ip_address, timestamp, user_id, user_name, application_id, application_name, window_id, window_title, duration)
...
def main():
    ...
    try:
        ...
        for file_path in files:
            ...
            new_name = os.path.join(archive_dir, os.path.basename(file_path) + ".processed")
